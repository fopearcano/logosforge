...
from storyplanner.api import schemas, serializers
from storyplanner.api.deps import get_broker, get_db, get_project
from storyplanner.api.errors import not_implemented
...
def delete_project(project=Depends(get_project)):
    # The core has no safe project-deletion routine; deleting a whole project
    # via the API is intentionally not supported.
    raise not_implemented(
        "Deleting a project is not supported via the API",
    )
