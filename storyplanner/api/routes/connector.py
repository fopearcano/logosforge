...
def list_actions(project=Depends(get_project)):
    import storyplanner.connector_actions  # noqa: F401  (populate registry)
    from storyplanner.connector_registry import describe_all_actions
...
def _action_category(action: str) -> str:
    import storyplanner.connector_actions  # noqa: F401
