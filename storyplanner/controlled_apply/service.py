...
from storyplanner.controlled_apply.conflicts import (
    detect_apply_conflicts, has_blocking,
)
from storyplanner.controlled_apply.diff import build_apply_diff
from storyplanner.controlled_apply.targets import get_adapter
...
def build_apply_preview(
    ...
    from storyplanner.controlled_apply.targets import _compose
