...
from storyplanner import screenplay as sp
...
def preview_draft_apply(
    ...
    if err:
        return None
    from storyplanner.controlled_apply.service import build_apply_preview
...
def beat_plan_context(db, project_id: int, scene_id: int | None) -> str:
    ...
    if scene_id is None:
        return ""
    try:
        from storyplanner.writing_modes import get_project_writing_mode_by_id, SCREENPLAY
