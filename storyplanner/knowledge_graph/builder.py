...
from storyplanner.knowledge_graph.extractor_notes import extract_notes
from storyplanner.knowledge_graph.extractor_psyke import extract_psyke
from storyplanner.knowledge_graph.extractor_revision import (
    extract_apply,
    extract_revision,
    extract_rewrite,
)
from storyplanner.knowledge_graph.extractor_structure import extract_structure
from storyplanner.knowledge_graph.extractor_workflow import (
    extract_setup_payoff,
    extract_workflows,
)
from storyplanner.knowledge_graph.models import KnowledgeGraph
from storyplanner.knowledge_graph.scoring import (
    ...
    for row in rows:
        ...
        if live is not None:
            ...
            if row.source_node_key in graph.nodes and row.target_node_key in graph.nodes:
                from storyplanner.knowledge_graph.models import KGEdge
