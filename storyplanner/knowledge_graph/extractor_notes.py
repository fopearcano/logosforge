...
from storyplanner.knowledge_graph.models import KGEdge, KGNode, node_key
...
def extract_notes(db, project_id: int, graph) -> list[str]:
    ...
    try:
        ...
        from storyplanner.revision_intelligence.psyke_impact import _mentioned, _names
    except Exception:
    ...
    for e in entries:
        from storyplanner.knowledge_graph.extractor_psyke import psyke_node_key
