...
* parsing/serialization reuse :mod:`storyplanner.graphic_novel_blocks`;
* draft cleaning + validation reuse :mod:`storyplanner.graphic_novel_pipeline`
...
def build_rewrite_request(
    ...
    if include_health:
        try:
            from storyplanner.graphic_novel_diagnostics import analyze_scene_by_id
