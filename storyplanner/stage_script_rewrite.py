...
* parse/serialize + validation reuse :mod:`storyplanner.stage_script_blocks`;
* fence-stripping + leak phrases + the draft validation dataclass reuse
  :mod:`storyplanner.stage_script_pipeline`;
* apply + checkpoint reuse :mod:`storyplanner.controlled_apply`
...
def build_rewrite_request(
    ...
    if include_health:
        try:
            from storyplanner.stage_script_diagnostics import analyze_scene_by_id
    ...
    if include_reflection:
        try:
            from storyplanner.stage_script_reflection import build_scene_reflection
...
def build_rewrite_preview(
    ...
    try:
        ...
        preview.block_diff = {}
    try:
        from storyplanner.controlled_apply.diff import build_apply_diff
