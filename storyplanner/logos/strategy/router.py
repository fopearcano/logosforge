...
from storyplanner.logos.strategy import conflicts, context_policy, explanation
from storyplanner.logos.strategy import medium_profiles as mp
from storyplanner.logos.strategy import registry as reg
from storyplanner.logos.strategy.strategy import StrategyDecision
...
class StrategyRouter:
    ...
    def _controlling_idea_enabled(self) -> bool:
        try:
            from storyplanner.controlling_idea import load as load_ci
