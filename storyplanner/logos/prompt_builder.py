...
system: it calls the existing ``storyplanner.context_builder`` gatherers and the
existing ``storyplanner.assistant.build_messages``.
...
from storyplanner.logos.actions import LogosAction
