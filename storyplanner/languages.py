...
* **Dexter Language** — transcription language for Dexter's Room. Defaults to
  ...
  or an explicit per-setup override (see :mod:`storyplanner.voice.types`).
...
* **Software UI Language** — the application interface language
  (:mod:`storyplanner.i18n`); global, separate from any project.
...
# code). This is the single source of truth; storyplanner.voice.types
...
# ---------------------------------------------------------------------------
# UI translation availability (see storyplanner.i18n)
# ---------------------------------------------------------------------------
