...
from storyplanner import graphic_novel_diagnostics as gd
from storyplanner import graphic_novel_reflection as gr
from storyplanner import graphic_novel_rewrite as grw
from storyplanner import graphic_novel_continuity as grc
from storyplanner import graphic_novel_dashboard as gnd
...
def test_writing_mode_identification():
    from storyplanner.writing_modes import get_project_writing_mode_by_id, GRAPHIC_NOVEL
    db = Database()
    gn = _gn(db, "G")
