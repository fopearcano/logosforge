...
from storyplanner import graphic_novel_blocks as gn
from storyplanner.writing_modes import current_primary_unit_type
...
def test_universal_manuscript_reused_no_separate_gn_section(tmp_path):
    ...
    # Page/Panel Navigator over the SAME shared Scene.content body. There is still
    ...
    # The single Manuscript section hosts the GN Page/Panel Navigator.
...
def test_panel_check_logos_action_mode_gated_and_deterministic():
    from storyplanner.logos import actions as A, deterministic as det
