...
class TestAtomicWrite:
    ...
    def test_atomic_against_partial_read(self, tmp_path):
        ...
        with patch("storyplanner.cloud_storage.os.replace", side_effect=spy_replace):
...
class TestCloudDetection:
    ...
    def test_classify_local_path(self, tmp_path):
        ...
        with patch(
            "storyplanner.cloud_storage.detect_cloud_folders", return_value=[],
        ):
    ...
    def test_classify_inside_cloud_folder(self, tmp_path):
        ...
        cloud_root.mkdir()
        with patch(
            "storyplanner.cloud_storage.detect_cloud_folders",
