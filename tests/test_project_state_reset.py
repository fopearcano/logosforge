...
from storyplanner.ui.multi_plot_view import MultiPlotView, _TimelineStrip, _ArcLanes, _CharLanes
...
def test_import_clears_caches(tmp_path):
    ...
    with open(str(path), "r") as f:
        raw = f.read()
    from storyplanner.import_data import validate_import_data, import_json
