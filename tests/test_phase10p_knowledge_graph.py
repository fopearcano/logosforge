...
def test_assistant_block_empty_without_scene_in_policy():
    from storyplanner.assistant_context_policy import _knowledge_graph_block
    db, pid, aid, bid, s1, s2 = _project()
...
def test_graph_cleanup_workflow_present():
    from storyplanner.guided_workflows import list_workflow_templates
...
def test_graph_cleanup_workflow_starts():
    from storyplanner.guided_workflows import start_workflow
    db, pid, aid, bid, s1, s2 = _project()
