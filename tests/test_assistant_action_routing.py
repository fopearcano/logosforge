...
def test_contract_has_no_provider_dependency():
    import importlib
    import sys
    for m in ("storyplanner.providers", "storyplanner.assistant"):
        sys.modules.pop(m, None)
    importlib.import_module("storyplanner.assistant_contract")
    assert "storyplanner.providers" not in sys.modules
