...
from storyplanner.voice.glossary import (
...
from storyplanner.voice.history import S_CORRECTED, VoiceTranscriptHistory
...
def test_dialog_import_requires_confirmation(monkeypatch):
    db, pid, win = _ui_window()
    db.create_psyke_entry(pid, "Zampanò", entry_type="character")
    from storyplanner.ui.voice_glossary_dialog import VoiceGlossaryDialog
