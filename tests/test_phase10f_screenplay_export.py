...
from storyplanner import screenplay_render as sr
...
def test_unsupported_block_produces_warning():
    from storyplanner.screenplay_render import ScreenplayRenderBlock
...
def test_title_page_exports_to_fountain():
    from storyplanner.export import export_fountain
    db = Database()
    pid = _film(db)
...
def test_note_parser_roundtrip():
    from storyplanner.screenplay_blocks import parse_screenplay_text, to_fountain
...
def test_novel_export_unbroken():
    from storyplanner.export import export_manuscript, export_json
    db = Database()
...
def test_orphan_parenthetical_detected():
    ...
    from storyplanner import screenplay_export_validation as v
...
def test_preview_html_export():
    from storyplanner.export import export_screenplay_preview_html
    db = Database()
    pid = _film(db)
...
def test_validation_json_export_has_metadata():
    from storyplanner.export import export_screenplay_export_validation_json
    db = Database()
    pid = _film(db)
