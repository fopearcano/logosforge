"""Tests for the Local PC Writer QA Agent Mode (storyplanner/qa_mode.py).
...
def test_valid_auto_infers_mode():
    from storyplanner.assistant_contract import route, system_prompt_for
...
def test_export_local_report_cli(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "storyplanner.assistant.chat_completion",
