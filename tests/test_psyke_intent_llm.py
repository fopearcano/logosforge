...
from storyplanner.psyke_intent_llm import _parse_response, _validate_args, detect_intent_llm
from storyplanner.psyke_intents import Intent, detect_intent, intent_to_command
...
class TestLLMIntegration:
    ...
    def test_successful_classification(self):
        ...
        with patch("storyplanner.psyke_intent_llm.chat_completion") as mock:
...
class TestDetectIntentWithLLMFlag:
    ...
    def test_rule_match_skips_llm(self):
        with patch("storyplanner.psyke_intent_llm.detect_intent_llm") as mock:
