...
def test_mode_order_matches_registry():
    assert set(MODE_ORDER) == set(MODE_PROFILES.keys())
...
def test_all_mode_restores_full_layers():
    ...
    from storyplanner.ui.focus_graph_view import LAYER_KINDS
...
def test_quantum_mode_loads_active_wavefunctions():
    ...
    from storyplanner.quantum_outliner import get_state
