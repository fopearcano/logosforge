...
Proves the new isolated packages (`storyplanner.memory_arch`,
`storyplanner.assistant_arch`) are safe, non-destructive interface stubs:
...
from storyplanner.memory_arch.store import InMemoryMemoryStore
...
from storyplanner.assistant_arch.model_gateway import (
    DummyModelProvider,
    ModelGateway,
    ModelRequest,
    ProviderType,
)
from storyplanner.assistant_arch.tools import AssistantTools
...
def test_find_contradictions_stub_empty():
    ...
    from storyplanner.memory_arch.contradictions import ContradictionChecker
...
def test_imports_have_no_external_deps():
    import importlib
    for mod in ("storyplanner.memory_arch",
                "storyplanner.memory_arch.schema",
                "storyplanner.memory_arch.store",
                "storyplanner.memory_arch.policy",
                "storyplanner.memory_arch.retrieval",
                "storyplanner.memory_arch.contradictions",
                "storyplanner.memory_arch.sync",
                "storyplanner.memory_arch.github_export",
                "storyplanner.assistant_arch",
                "storyplanner.assistant_arch.model_gateway",
                "storyplanner.assistant_arch.context_builder",
                "storyplanner.assistant_arch.orchestration",
                "storyplanner.assistant_arch.tools"):
