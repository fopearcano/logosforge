...
import storyplanner.controlled_apply.service as CA
from storyplanner.controlled_apply import targets as T
...
def test_rewrite_apply_routes_through_controlled_apply():
    import storyplanner.rewrite_sandbox.engine as E
    db, pid, sid = _proj()
