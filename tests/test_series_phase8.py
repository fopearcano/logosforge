...
from storyplanner import series_rewrite as srw
from storyplanner import series_continuity as scont
from storyplanner import series_dashboard as sdash
...
_SERIES_MODULES = (
    "storyplanner/series_blocks.py", "storyplanner/series_pipeline.py",
    "storyplanner/series_diagnostics.py", "storyplanner/series_reflection.py",
    "storyplanner/series_rewrite.py", "storyplanner/series_continuity.py",
    "storyplanner/series_dashboard.py", "storyplanner/ui/series_review_view.py",
)
