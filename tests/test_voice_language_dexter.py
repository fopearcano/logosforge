...
def test_startup_needs_no_model_files_and_degrades_gracefully():
    ...
    from storyplanner.voice.setup import build_backend_profile
...
def test_privacy_note_uses_dexters_room_wording():
    from storyplanner.voice.types import PRIVACY_NOTE
...
def test_language_list_complete_and_auto_first():
    from storyplanner.voice.setup import LANGUAGES
...
def test_whisper_cpp_language_argument_construction(tmp_path):
    ...
    from storyplanner.voice.transcriber import WhisperCppTranscriber
