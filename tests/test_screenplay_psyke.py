...
from storyplanner.db.database import CONTINUITY_MEMORY_TYPES
from storyplanner.models.psyke_details import get_detail_schema
from storyplanner.models.models import PSYKE_RELATION_TYPES
from storyplanner.export import _gather_project_data, export_json
...
def test_assistant_sees_character_screenplay_details():
    ...
    from storyplanner.context_builder import render_psyke_details
    db = Database()
    proj = db.create_project("Film", format_mode="screenplay")
    entry = db.create_psyke_entry(
        proj.id,
