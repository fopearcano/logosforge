...
from storyplanner.quantum_outliner.collapse import collapse, _build_proposals
...
class TestEndToEnd:
    ...
    def test_scene_linkage_persists_through_serialization(self, db, project):
        ...
        from storyplanner.quantum_outliner.state import deserialize_state, serialize_state
