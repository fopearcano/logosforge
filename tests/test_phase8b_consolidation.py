...
def test_wrappers_delegate_to_central_builder():
    ...
    import storyplanner.paragraph_energy as pe
    import storyplanner.style_analysis as sa
    import storyplanner.psyke_intent_llm as pil
    import storyplanner.quantum_outliner.possibilities as poss
    import storyplanner.quantum_outliner.llm_evaluator as lev
    import storyplanner.quantum_outliner.relativity as rel
    import storyplanner.api.routes.assistant as api_assist
...
def test_conceptual_event_map_documents_real_signals():
    from storyplanner.project_events import CONCEPTUAL_EVENT_MAP
...
def test_emit_conceptual_raises_real_signals():
    from storyplanner.project_events import emit_conceptual, get_event_bus
    bus = get_event_bus()
    fired = {"scene": [], "data": 0}
