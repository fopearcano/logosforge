...
from storyplanner.logos.strategy import (
    StrategyRouter,
    gather_strategy_context,
    get_strategy,
    list_strategies,
)
from storyplanner.logos.strategy import registry as reg
from storyplanner.logos.strategy.conflicts import (
    resolve_causality,
...
def test_logos_actions_differ_by_mode():
    ...
    assert sa != na
    # Screenplay surfaces dialogue economy first; novel surfaces revision/voice.
    assert sa[0] == "improve_dialogue"
