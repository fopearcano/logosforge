...
def test_outline_structural_units_adapt(engine, expected_top):
    from storyplanner.outline_actions import engine_structural_units
...
def test_export_markdown_includes_writing_mode():
    from storyplanner.export import export_markdown
    db = Database()
...
def test_data_export_metadata_includes_writing_mode():
    from storyplanner.data_export import _project_meta, ExportOptions
    db = Database()
