...
from storyplanner.assistant_arch.context_builder import AssistantContextBuilder
...
from storyplanner.memory_arch.policy import (
    MemoryWriterPolicy,
    PolicyDecision,
    PolicyResult,
)
...
def test_no_external_calls(monkeypatch):
    ...
    from storyplanner.memory_arch import github_export, sync
