...
def test_core_chapter_scene_architecture_intact():
    ...
    from storyplanner.models import Chapter, Scene  # noqa: F401
    from storyplanner.outline_actions import (  # noqa: F401
...
def test_no_chapter_manuscript_debris():
    ...
    with pytest.raises(ModuleNotFoundError):
        importlib.import_module("storyplanner.ui.chapter_manuscript_view")
