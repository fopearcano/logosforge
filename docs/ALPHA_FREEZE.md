...
- `storyplanner/autosave.py`, `storyplanner/version_manager.py`
- Project switch / lock / lifecycle (`project_lifecycle.py`, `recent_projects.py`,
  `cloud_storage.py`)
- DB models & migrations (`storyplanner/models/`, `storyplanner/db/database.py`)
- Shared provider backend (`storyplanner/providers.py::build_active_provider`,
  `storyplanner/assistant.py`)
