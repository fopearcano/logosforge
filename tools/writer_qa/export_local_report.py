...
provider** in `storyplanner.qa_mode` (NO real provider / network / cloud /
...
from storyplanner import qa_mode                                       # noqa: E402
from storyplanner.assistant_contract import (                         # noqa: E402
