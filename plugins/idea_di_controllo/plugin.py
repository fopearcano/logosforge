"""Idea di Controllo plugin for Storyplanner.
...
def register(api) -> None:  # noqa: ANN001 — PluginAPI duck-typed
    ...
    def _show_idea() -> None:
        ...
        if db is None:
            ...
            return
        from storyplanner.controlling_idea import (
    ...
    def _check_idea() -> None:
        ...
        if db is None:
            ...
            return
        from storyplanner.controlling_idea import check
        report = check(db, pid)
    ...
    def _link_theme() -> None:
        ...
        if db is None:
            api.show_message("Idea di Controllo", "No project loaded.")
            return
        from storyplanner.controlling_idea import ensure_theme_entry, load
...
def _get_db(api):
    ...
    :mod:`storyplanner.controlling_idea`, which calls already-public db
